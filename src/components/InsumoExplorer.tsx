...
interface Insumo{codigo:string;descripcion:string;unidad:string;precio_unitario:number;categoria:string|null;tipo_registro:string;nivel_confianza:number;status:string;es_outlier:boolean;z_precio:number|null;activo:boolean;}
    ...
    <div className="min-h-screen bg-[#04040A] text-white">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8 space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-black text-white flex items-center gap-3"><Package className="w-7 h-7 text-[#6366F1]"/>Catálogo de Insumos</h1>
            <p className="text-[#666688] text-sm mt-1">Resultado del análisis con Gemini Flash · CDMX 2026</p>
          </div>
          <button onClick={cargar} className="flex items-center gap-1.5 px-4 py-2.5 rounded-xl bg-[#0F0F1E] border border-[#1A1A2E] hover:border-[#6366F1]/40 text-[#8888AA] text-sm transition-all">
        ...
        <p className="text-[#111120] text-xs text-center">Catálogo APUCMX · CDMX 2026 · Precios estimados, sujetos a verificación.</p>
      </div>
    </div>
  );
};
